...
//   return (
//     <form className='flex flex-col items-center justify-center mt-auto bg-stone-950 '>
...
//       <button className= 'text-black'onClick={checkpassword} formAction={signup} >SignUP</button>
//     </form>
//   )
// }
